      ...
      for(i=0;i<obj.links.length;i++){
          ...
          for(j=0;j<section.slinks.length;j++){
              ...
              if(link[3]===true){
                ...
                if(obj.withPdf){
                  if(link[5]){
                    persistLink(section,i,j,link[0]+".1.pdf",link[5]);
                  }
                  if(link[6]){
                    persistLink(section,i,j,link[0]+".2.pdf",link[6]);
                  }
                  if(link[7]){
                    persistLink(section,i,j,link[0]+".3.pdf",link[7]);
                  }
                  if(link[8]){
                    persistLink(section,i,j,link[0]+".4.pdf",link[8]);
                  }
                }
                if(obj.withPptx){
                  if(link[10]){
                    persistLink(section,i,j,link[0]+".pptx",link[10]);
                  }
                }
              }
          }
